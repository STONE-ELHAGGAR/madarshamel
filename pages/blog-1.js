                        ...
                        <div className="container mt-30">
                            <div className="row">
                                ...
                                <div className="col-lg-10 col-sm-10 col-12 text-center">
                                    ...
                                    <p className="text-body-lead-large color-gray-600 mt-20">From Our Blog</p>
                                </div>
                                <div className="col-lg-1 col-sm-1 col-12" />
                            </div>
                        </div>
                        <div className="container mt-90">
                            <div className="row">
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Category</span>
                                        <Link href="/blog-single"><a className="text-heading-4">Replaceable text you can edit later.
                                        </a></Link>

                                        <div className="grid-4-img">
                                            <Link href="/blog-single"><a><img src="/assets/imgs/page/homepage1/img-news-1.png" alt="Madarshamel" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Category</span>
                                        ...
                                        <div className="grid-4-img">
                                            <Link href="/blog-single"><a><img src="/assets/imgs/page/homepage1/img-news-2.png" alt="Madarshamel" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Category</span>
                                        ...
                                        <div className="grid-4-img color-bg-4">
                                            ...
                                            <Link href="/blog-single"><a><img src="/assets/imgs/page/homepage1/img-news-3.png" alt="Madarshamel" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Category</span>
                                        ...
                                        <div className="grid-4-img">
                                            <Link href="/blog-single"><a><img src="/assets/imgs/page/homepage1/img-news-4.png" alt="Madarshamel" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Category</span>
                                        ...
                                        <div className="grid-4-img">
                                            <Link href="/blog-single"><a><img src="/assets/imgs/page/homepage1/img-news-5.png" alt="Madarshamel" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Category</span>
                                        ...
                                        <div className="grid-4-img color-bg-4">
                                            ...
                                            <Link href="/blog-single"><a><img src="/assets/imgs/page/homepage1/img-news-6.png" alt="Madarshamel" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Category</span>
                                        ...
                                        <div className="grid-4-img color-bg-2">
                                            ...
                                            <Link href="/blog-single"><a><img src="/assets/imgs/page/homepage1/img-news-7.png" alt="Madarshamel" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Category</span>
                                        ...
                                        <div className="grid-4-img color-bg-8">
                                            ...
                                            <Link href="/blog-single"><a><img src="/assets/imgs/page/homepage1/img-news-8.png" alt="Madarshamel" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-12 pr-30 mb-50">
                                    <div className="card-grid-style-4"><span className="tag-dot">Category</span>
                                        ...
                                        <div className="grid-4-img color-bg-1">
                                            ...
                                            <Link href="/blog-single"><a><img src="/assets/imgs/page/homepage1/img-news-9.png" alt="Madarshamel" />
                                            </a></Link>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="mt-20 mb-30 text-center">
                                <Link href="#"><a className="btn btn-black icon-arrow-right-white">Load more posts
                                </a></Link>
                            </div>
                        </div>
                    </section>
