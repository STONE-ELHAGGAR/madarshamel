                        ...
                        <div className="content-detail">
                            <div className="row">
                                ...
                                <div className="col-lg-8">
                                    ...
                                    <p className="text-body-text">The Madarshamel Design team has a vision to establish a trusted platform that enables productive and healthy enterprises in a world of digital and remote everything, constantly changing work patterns and norms, and the need for organizational resiliency.</p>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-10">
                                    <div className="box-image mt-30 mb-30">
                                        <img className="img-responsive bdrd-16" src="assets/imgs/page/career/img.png" alt="Madarshamel" /></div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-lg-2" />
                                <div className="col-lg-8">
                                    ...
                                    <div className="media-block">
                                        ...
                                        <div className="float-start float-lg-end mt-30">
                                            <Link href="/#"><a className="btn btn-media mr-10"><img src="/assets/imgs/template/icons/facebook-share.svg" alt="Madarshamel" /> Share</a></Link>

                                            <Link href="/#"><a className="btn btn-media mr-10"><img src="/assets/imgs/template/icons/twitter-share.svg" alt="Madarshamel" /> Tweet</a></Link>

                                            <Link href="/#"><a className="btn btn-media"><img src="/assets/imgs/template/icons/pinterest-share.svg" alt="Madarshamel" /> Pin</a></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
